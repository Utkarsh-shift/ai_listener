...
def start_ec2_instance():
    ...
    try:
        ...
        print("The test here is *********************************************8")
        ip = "10.0.8.162"
        ec2_user = "ubuntu"
        key_path = "/home/ubuntu/DjangiAVItest/EC2kaypair.pem"
   #     ssh = paramiko.SSHClient()
   #     ssh.set_missing_host_key_policy(paramiko.AutoAddPolicy())
   #     ssh.connect(ip, username=ec2_user, key_filename=key_path)
   ...
   #         print(stderr.read().decode())
        bash_file_path = "/home/ubuntu/DjangiAVItest/AIinterview/resultsUI/script.sh"

        try:
               result = subprocess.run(["bash", bash_file_path], check=True, text=True, capture_output=True)
...
#        )
        print("After the Amazon AAM Inter Core")
